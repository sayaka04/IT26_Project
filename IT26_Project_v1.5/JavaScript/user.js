  ...
  class mySideBar extends HTMLElement {
    connectedCallback() {
        ...
        <div class="list-group list-group-flush">
            <a href="../user-portal/user-dashboard.html" class="list-group-item list-group-item-action"><i class="bi bi-clipboard2-data"> </i>Dashboard</a>
            <a href="../user-portal/user-books.html" class="list-group-item list-group-item-action"><i class="bi bi-book"> </i>Books</a>
            <a href="../user-portal/user-transaction.html" class="list-group-item list-group-item-action"><i class="bi bi-arrow-left-right"> </i>Transactions</a>
            <a href="#" class="list-group-item list-group-item-action"><i class="bi bi-hourglass-split"> </i>Pending Returns</a>
            <a href="#" class="list-group-item list-group-item-action"><i class="bi bi-bell"> </i>Notification</a>
            <a href="#" class="list-group-item list-group-item-action"><i class="bi bi-bookmark"> </i>Bookmarks</a>
        </div>
        `;
